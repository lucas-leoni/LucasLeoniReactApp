          ...
          <div className="row justify-content-between">
            ...
            <div className="col-4 d-flex align-items-center justify-content-end">
              <ul className="d-flex list-unstyled m-0">
                <li>
                  <NavLink exact to={'/'} aria-current="page">
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.75rem" viewBox="0 0 512 512" style={{ fill: '#0DCAF0' }}>
                ...
                <li className="ms-3">
                  <NavLink exact to={'/'} aria-current="page">
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.75rem" viewBox="0 0 448 512" style={{ fill: '#0DCAF0' }}>
